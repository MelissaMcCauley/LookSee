"""
Django settings for looksee project.
...
SECRET_KEY = ')^2)j4=$-_(at%&##+h%wgomxq(u)n)*#59d@vuy2&hfl7xais'
...
WSGI_APPLICATION = 'looksee.wsgi.application'
